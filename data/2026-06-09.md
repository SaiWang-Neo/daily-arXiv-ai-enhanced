...
### [19] [XAInomaly: Explainable and Interpretable Deep Contractive Autoencoder for O-RAN Traffic Anomaly Detection](https://arxiv.org/abs/2502.09194)
...
### [20] [BRAIN: Bayesian Reasoning via Active Inference for Agentic and Embodied Intelligence in Mobile Networks](https://arxiv.org/abs/2602.14033)
...
### [21] [Large-time behavior and accuracy of the Mean-Field Ensemble Kalman Filter in the Linear Detectable Setting](https://arxiv.org/abs/2606.07729)
...
### [22] [Non-Archimedean Polydisc Spaces and Applications to Optimisation](https://arxiv.org/abs/2606.07782)
...
### [23] [On the sharp linear convergence rate of the circumcentered--reflection method on subspaces](https://arxiv.org/abs/2606.07888)
*Yunier Bello-Cruz*
...
### [24] [Verification Framework for the Union of Control Barrier Functions](https://arxiv.org/abs/2606.07892)
...
### [25] [Data-Driven Robust Model Reference Adaptive Control with Parameter Convergence](https://arxiv.org/abs/2606.07911)
...
### [26] [Combining Reinforcement Learning with Arc-search Interior-Point Method for Path Planning](https://arxiv.org/abs/2606.07920)
...
### [27] [A null controllability data assimilation for the bulk-surface heat equation with dynamic boundary conditions](https://arxiv.org/abs/2606.07942)
...
### [28] [An Iterative Computational Framework for Infinite-Horizon Mean-Field Linear-Quadratic Zero-Sum Stochastic Differential Games](https://arxiv.org/abs/2606.08145)
*Yiyuan Wang*
...
### [29] [Latent Structural Categorical Matrix Completion with Application to Quasispecies Analysis](https://arxiv.org/abs/2606.08188)
...
### [30] [Equivalence between time and norm optimal control problems of stochastic differential equations](https://arxiv.org/abs/2606.08219)
*Yanqing Wang*
...
### [31] [Robust Optimization for Green Ammonia Production](https://arxiv.org/abs/2606.08335)
...
### [32] [Temperature control by a state-delay nash strategy: theory and experiments](https://arxiv.org/abs/2606.08344)
...
### [33] [Advancing Branch-and-Price for Graph Coloring: New Pricing Strategies and Benchmark Results](https://arxiv.org/abs/2606.08356)
...
### [34] [Variational Analysis of Metric Projections onto Isotone Projection Cones via Coderivatives](https://arxiv.org/abs/2606.08386)
*Le Van Hien*
...
### [35] [Augmented Lagrangian methods for nonlinear semidefinite programming with complementarity constraints](https://arxiv.org/abs/2606.08424)
...
### [36] [Optimal Harvesting under Stochastic Control: HJB Equation and Feynman-Kac Representation](https://arxiv.org/abs/2606.08428)
...
### [37] [Block coordinate descent for joint delay-energy optimization in multi-hop D2D networks](https://arxiv.org/abs/2606.08544)
...
### [38] [Parameter Tuning with Generalization Guarantees for GPU-Accelerated Linear Programming](https://arxiv.org/abs/2606.08638)
...
### [39] [Explainable Optimization: A Call for Interdisciplinary Action](https://arxiv.org/abs/2606.08675)
...
### [40] [OptMuon: Closed-Loop Orthogonalized Momentum Methods for Stochastic Optimization with Zero-Noise Optimality](https://arxiv.org/abs/2606.08783)
*Ganzhao Yuan*
...
### [41] [Optimal Control and Dissipativity of Linear Hermitian Matrix-Valued Dynamical Systems](https://arxiv.org/abs/2606.08856)
*Corentin Briat*
...
### [42] [Not All Warm Starts Help: Benchmarking Primal-Dual Initializations for ACOPF Algorithms](https://arxiv.org/abs/2606.08984)
...
### [43] [Time-Varying Perturbations of Contractive Systems With an Application to Safe Stabilization](https://arxiv.org/abs/2606.09035)
...
### [44] [Particle Methods with Deep Learning for Stochastic Control under Partial Observation](https://arxiv.org/abs/2606.09055)
...
### [45] [Quantitative rapid stabilization for parabolic equations via the linear quadratic theory](https://arxiv.org/abs/2606.09063)
...
### [46] [Beyond Fixed Local Updates: An Adaptive Decentralized Quasi-Newton Method Free of Stepsize Degradation](https://arxiv.org/abs/2606.09070)
*Hao Wu,Liping Wang*
...
### [47] [Impact of Scaling and Rounding on Metaheuristic Performance for the Vehicle Routing Problem with Time Windows](https://arxiv.org/abs/2606.09196)
...
### [48] [Multilevel Stochastic Gradient Descent for Risk-Averse PDE-Constrained Optimization](https://arxiv.org/abs/2606.09291)
...
### [49] [Inverse Problems for Costs and Controls in LQG MFGs via Mean Field Trajectories](https://arxiv.org/abs/2606.09302)
...
### [50] [Generalized Cancellation of Capacitor Parasitic Inductance Using a Lattice Network and Its Application to Common-Mode Noise Reduction](https://arxiv.org/abs/2606.09326)
...
### [51] [Second order Taylor-like topological expansion with multiple holes](https://arxiv.org/abs/2606.09363)
*Kevin Sturm*
...
### [52] [Benchmarking Deep Time Series Models for Equity Portfolios](https://arxiv.org/abs/2606.09420)
...
### [53] [Metric-Free Riemannian Optimization](https://arxiv.org/abs/2606.09465)
*Jonas Püschel*
...
### [54] [Complete Trajectory Tracking for Polynomial Differential Variational Inequalities: A Moment-SOS Based Structure-Aware Approach](https://arxiv.org/abs/2606.09609)
...
### [55] [Powering the Future of AI: Navigating the Trade-offs for Europe's Energy Transition and Net-Zero Goals](https://arxiv.org/abs/2606.09617)
...
### [56] [Mean field games with option to buy information](https://arxiv.org/abs/2606.09784)
...
### [57] [Limit Theory for $N$-Player $α$-Potential Games](https://arxiv.org/abs/2606.09815)
...
### [58] [FADRW: A Feature-Aware Modulated and Dynamically Reweighted Loss for Few-Shot Linguistic Steganalysis](https://arxiv.org/abs/2606.07655)
...
### [59] [Hessian-matching Based Weighting for Attitude Determination Using Short-Range DoA Measurements with IMU Assistance](https://arxiv.org/abs/2606.07719)
...
### [60] [Optimal Wiener-Filter Solutions for Denoising of Graph Signals on Directed Graphs](https://arxiv.org/abs/2606.07876)
...
### [61] [A Double Proportionate Sparse Adaptive Filter for Impulsive Noise Environments](https://arxiv.org/abs/2606.08225)
...
### [62] [CG-MambaNet: A spatiotemporal framework for cross-patient epileptic seizure prediction using CNN-GCN-Mamba-BiLSTM with event-level clinical evaluation](https://arxiv.org/abs/2606.08226)
...
### [63] [A dual-system approach for epilepsy diagnosis: integrating mamba-Bi-LSTM architecture with SHAP-based verification](https://arxiv.org/abs/2606.08240)
...
### [64] [Spatio-Sequential Recurrent Network for 3-D Tunnel Propagation Modeling](https://arxiv.org/abs/2606.08246)
...
### [65] [Feedforward Nonlinear Equalizer for Short- to Medium-Reach Wireline Links](https://arxiv.org/abs/2606.08313)
...
### [66] [Enhanced Wide-Angle Steering with Multi-Mode Multi-Port Aperture Antenna Arrays](https://arxiv.org/abs/2606.08320)
...
### [67] [A Switching Beamformer for Highly Non-Stationary Environments](https://arxiv.org/abs/2606.08385)
...
### [68] [Mixture-of-Experts Transformer for Automatic Modulation Recognition](https://arxiv.org/abs/2606.09085)
...
### [69] [RSMA Technique for Multi-User Downlink Single-Waveguide Multi-Pinching Antenna Systems](https://arxiv.org/abs/2606.09095)
...
### [70] [Towards Intelligent Wireless Networks: The Synergy of Generative AI and Digital Twins](https://arxiv.org/abs/2606.09113)
...
### [71] [Block-Term Decomposition Approach to Blind Multi-trial Functional Ultrasound Unmixing](https://arxiv.org/abs/2606.09264)
...
### [72] [Wearable Single-Lead ECG Detects Fine-Grained Structural Heart Disease Through Echo-Report Supervision](https://arxiv.org/abs/2606.09332)
...
### [73] [Orbital Plane Geometry and Information Conditioning for Doppler-Only LEO Positioning](https://arxiv.org/abs/2606.09496)
*Charles E Thornton*
...
### [74] [Hierarchical Federated Learning for Unsupervised Waveform Classification over Tactical MANETs](https://arxiv.org/abs/2606.09504)
...
### [75] [Bernoulli Filtering for Multi-Sensor Tracking with Thresholded Measurements](https://arxiv.org/abs/2606.09573)
...
### [76] [Throughput Analysis for Near-Field Mobile Communications: Beamfocusing or Caustic Beamforming?](https://arxiv.org/abs/2606.09652)
...
### [77] [Jamming-Resilient Sparse Delay-Doppler NOMA: Unitary Precoding, Randomized Active Sets, and Superincreasing Power Allocation](https://arxiv.org/abs/2606.09753)
...
### [78] [Adaptive Derivative Estimation via Stein's Unbiased Risk](https://arxiv.org/abs/2606.09829)
...
### [79] [Physics-Embedded Neural Networks for sEMG-based Continuous Motion Estimation](https://arxiv.org/abs/2506.22459)
...
### [80] [PathoSage: Towards Multi-Source Evidence Adjudication in Pathology via Experience-Aware Agentic Workflow](https://arxiv.org/abs/2606.07549)
...
### [81] [OmniMem: Perturbation-aware Memory Compression for Streaming Audio-Visual LLMs](https://arxiv.org/abs/2606.07577)
...
### [82] [Syll: Open-Source Personal Automation with Cross-Surface Execution](https://arxiv.org/abs/2606.07594)
...
### [83] [A case study of evaluating AI agents on a neuroscience data-to-discovery pipeline](https://arxiv.org/abs/2606.07718)
...
### [84] [Why Limit the Residual Stream to Layers and Not Tokens? Persistent Memory for Continuous Latent Reasoning](https://arxiv.org/abs/2606.07720)
...
### [85] [Automatic Extraction of Structured Information from Brain MRI Reports Using an Open-Weight Large Language Model](https://arxiv.org/abs/2606.07721)
...
### [86] [Some hypotheses on how chatbots work in problem-solving-driven conversations. Large Language Models as confirmation of the Innovation Illusion](https://arxiv.org/abs/2606.07722)
...
### [87] [Land cover and flood type govern the detection limits of satellite-based flood mapping across diverse global flood events](https://arxiv.org/abs/2606.07780)
...
### [88] [Beyond Goodhart's Law: A Dynamic Benchmark for Evaluating Compliance in Multi-Agent Systems](https://arxiv.org/abs/2606.07805)
...
### [89] [Reconstructing and forecasting disease trajectories of patients with Alzheimer's disease using routine data in resource-constrained settings](https://arxiv.org/abs/2606.07798)
...
### [90] [Improving Multimodal Reasoning via Worst Dimension Optimization](https://arxiv.org/abs/2606.07801)
...
### [91] [Overcoming the Regulatory Bottleneck via Agent-to-Agent Protocols: A Nuclear Case Study](https://arxiv.org/abs/2606.07866)
...
### [92] [SKILL.nb: Selective Formalization and Gated Execution for Durable Agent Workflows](https://arxiv.org/abs/2606.08049)
...
### [93] [Where Instruction Hierarchy Breaks: Diagnosing and Repairing Failures in Reasoning Language Models](https://arxiv.org/abs/2606.07808)
...
### [94] [PACE: Anytime-Valid Acceptance Tests for Self-Evolving Agents](https://arxiv.org/abs/2606.08106)
*Zayx Shawn*
...
### [95] [Scaling Participation in Modular AI Systems](https://arxiv.org/abs/2606.07812)
...
### [96] [To Nuke or Not to Nuke: LLMs' (Missing) Ethical Reasoning and Actions in a High-Stakes Decision-Making Simulation](https://arxiv.org/abs/2606.08310)
...
### [97] [Joint Structural Pruning and Mixed-Precision Quantization for LLM Compression](https://arxiv.org/abs/2606.07819)
...
### [98] [Benchmarking Open-Ended Multi-Agent Coordination in Language Agents](https://arxiv.org/abs/2606.08340)
...
### [99] [Quantitative Promise Theory: Intentionality and Inference in Autonomous Agents](https://arxiv.org/abs/2606.08552)
*Mark Burgess*
...
### [100] [Safety is Contextual, LLM-Judges Are Not: Navigating the Rigid Priors of Evaluators](https://arxiv.org/abs/2606.07874)
...
### [101] [RAILS: Verification-Native Clearing For Agentic Commerce](https://arxiv.org/abs/2606.08790)
...
### [102] [The AI Epistemic Deference Index: A Continuous Measure of Sycophancy](https://arxiv.org/abs/2606.07897)
...
### [103] [A Multi-Agent System for IPMSM Design Optimization via an FEA-AI Hybrid Approach](https://arxiv.org/abs/2606.09037)
...
### [104] [Contract2Tool: Learning Preconditions and Effects for Reliable Tool-Augmented LLM Agents](https://arxiv.org/abs/2606.07904)
...
### [105] [MemToolAgent overview with a simple restaurant booking scenario where the agent retrieves similar memories, receives feedback on an invalid time format, and generates a reflection to update its memory](https://arxiv.org/abs/2606.07909)
...
### [106] [EditSR: Enhancing Neural Symbolic Regression via Edit-based Rectification](https://arxiv.org/abs/2606.07915)
...
### [107] [TABVERSE: Benchmarking Cross-Format Table Understanding in LLMs and VLMs](https://arxiv.org/abs/2606.09578)
...
### [109] [Stress-testing medical large language models reveals latent safety pathology beyond benchmark accuracy](https://arxiv.org/abs/2606.07929)
...
### [110] [Unification of Closed-Open Industrial Detection Scenarios: New Large-Scale Benchmarks,Challenges and Baselines](https://arxiv.org/abs/2606.07953)
...
### [111] [Shared Latent Structures Enable Unified Backdoor Detection and Mitigation in LLMs](https://arxiv.org/abs/2606.07963)
...
### [112] [Zero-Shot Learning in Industrial Scenarios: New Large-Scale Benchmark, Challenges and Baseline](https://arxiv.org/abs/2606.07965)
...
### [113] [PAFO: Pareto Fairness Optimization for Personalized Reward Modeling](https://arxiv.org/abs/2606.07988)
...
### [114] [VATS: Exploiting Implicit Authority in Error-Path Injection via Systematic Mutation](https://arxiv.org/abs/2606.07992)
...
### [115] [Efficient Skill Grounding via Code Refactoring with Small Language Models](https://arxiv.org/abs/2606.07999)
...
### [116] [UniQL: Towards Dialect-Universal Benchmarking for Text-to-SQL](https://arxiv.org/abs/2606.08018)
...
### [117] [OSMGraphCLIP: Learning Global Location Representations from OpenStreetMap Graphs](https://arxiv.org/abs/2606.08046)
...
### [118] [How Small Can You Go? LoRA Fine-Tuning 270M-8B Models for Merchant Information Extraction in Financial Transactions](https://arxiv.org/abs/2606.08051)
...
### [119] [A Multi-modal Agentic Co-pilot for Evidence Grounded Computational Pathology](https://arxiv.org/abs/2606.08093)
...
### [120] [When Does Delegation Beat Majority? A Delegation-Based Aggregator for Multi-Sample LLM Inference](https://arxiv.org/abs/2606.08098)
...
### [121] [Think Before You Act: Intention-Guided Reasoning for LLM-Based Location Prediction](https://arxiv.org/abs/2606.08122)
...
### [122] [Cross-LLM Consistency in Inference: Evidence from Shared Interactions](https://arxiv.org/abs/2606.08129)
...
### [123] [SAGE: An LLM-driven Self Reflective Agentic Framework for Fraud Detection](https://arxiv.org/abs/2606.08146)
...
### [124] [Decision-Aware Memory Cards: Counterfactual-Inspired Context Selection and Compression for Tool-Using LLM Agents](https://arxiv.org/abs/2606.08151)
...
### [125] [Online Agent-as-a-Judge: Situation-Generating Evaluation for Interactive Agents](https://arxiv.org/abs/2606.08200)
...
### [126] [SciTrace: Trajectory-Aware Safety Reasoning for Scientific Discovery Agents](https://arxiv.org/abs/2606.08234)
...
### [127] [When No Answer Is Correct: Diagnosing Absent Answer Detection for MLLMs in Video Understanding](https://arxiv.org/abs/2606.08239)
...
### [128] [Traxia: A Framework for Verifiable, Agent-Native Scientific Publishing](https://arxiv.org/abs/2606.08256)
*Wisdom Dogah*
...
### [129] [From Validator Selection to Portfolio Collection Optimization in Proof-of-Stake Blockchains](https://arxiv.org/abs/2606.08282)
...
### [130] [Beyond Agent Architecture: Execution Assumptions and Reproducibility in LLM-Based Trading Systems](https://arxiv.org/abs/2606.08285)
...
### [131] [Ablation-Reversible Heads Don't Transfer: A Stress Test for Mechanistic Role Claims in Transformers](https://arxiv.org/abs/2606.08292)
*Philip Quirke*
...
### [132] [Revisiting the shutdown problem](https://arxiv.org/abs/2606.08296)
*David Thorstad*
...
### [133] [Curation of a Cardiology Interface Terminology for Highlighting Electronic Health Records using Machine Learning](https://arxiv.org/abs/2606.08311)
...
### [134] [Neuro-Symbolic Injection of LTLf Constraints in Autoregressive Reinforcement Learning Policies](https://arxiv.org/abs/2606.08312)
...
### [135] [Integrating Deep Learning Demand Forecasting with Multi-Objective Optimization for Circular Coffee Supply Chains: A Data-Driven Framework for Cost, Emissions, and Freshness Management](https://arxiv.org/abs/2606.08314)
...
### [136] [TT-DAC-PS: Twin-Target Deterministic Actor-Critic with Policy Smoothing for Optimal Trade Execution](https://arxiv.org/abs/2606.08379)
...
### [137] [Self-Evolving Scientific Agent Discovers Generalizable Physically-Reasoned Fluid Control](https://arxiv.org/abs/2606.08405)
...
### [138] [Trajectory-Refined Distillation](https://arxiv.org/abs/2606.08432)
...
### [139] [GIFT: LLM-Guided State-Reward Interface for Financial Reinforcement Learning](https://arxiv.org/abs/2606.08450)
...
### [140] [A Variability-Based Framework for Interpretable Naming in Formal and Relational Concept Analysis](https://arxiv.org/abs/2606.08477)
...
### [141] [Testing the Black Box: Structural Barriers to Independent Evaluation of Consumer-Facing Health LLMs](https://arxiv.org/abs/2606.08483)
...
### [142] [What Makes a Desired Graph for Relational Deep Learning?](https://arxiv.org/abs/2606.08491)
...
### [143] [Explaining Black-Box Language Models: Learning to Optimize Linguistically-Structured Word Subsets](https://arxiv.org/abs/2606.08497)
...
### [144] [Standpoint Logics with Defeasible Beliefs](https://arxiv.org/abs/2606.08503)
...
### [145] [Scaffold Effects on GAIA: A Controlled Comparison](https://arxiv.org/abs/2606.08529)
*Jason Starace*
...
### [146] [VESTA: A Fully Automated Scenario Generation and Safety Evaluation Framework for LLM Agents](https://arxiv.org/abs/2606.08531)
...
### [147] [DN-Hypo-Pipeline: An AI-Driven Workflow for Hypothesis Generation via Large Language Models and Scientific Explanations](https://arxiv.org/abs/2606.08532)
...
### [148] [AgentTrust: A Self-Improving Trust Layer for AI-Agent Actions](https://arxiv.org/abs/2606.08539)
*Chenglin Yang*
...
### [149] [PAEC: Position-Aware Entropy Calibration for LLM Reasoning in RLVR](https://arxiv.org/abs/2606.08543)
...
### [150] [Distilling LLM Reasoning into an Interpretable Policy Tree for Human-AI Collaboration](https://arxiv.org/abs/2606.08596)
...
### [151] [InA-Probe: Instruction-Aware Active Probing for Time Series Forecasting with LLMs](https://arxiv.org/abs/2606.08601)
...
### [152] [Towards Long-Horizon Vessel Trajectory and Destination Forecasting with Reasoning Large Language Models](https://arxiv.org/abs/2606.08633)
...
### [153] [Extending Ontologies: From Dense Embeddings to Hybrid Quantum-Fuzzy Systems](https://arxiv.org/abs/2606.08658)
*Angjelin Hila*
...
### [154] [ConMem: Structured Memory-Guided Adaptation in Training-Free Multi-Agent Systems](https://arxiv.org/abs/2606.08702)
...
### [155] [Artificial Intelligence for Mathematical Reasoning: An Integrated Survey of Language Models, Neuro-symbolic Systems, and Verified Discovery](https://arxiv.org/abs/2606.08728)
...
### [156] [Structure-Conditioned Actor-Critic Branches for Quality-Diversity Reinforcement Learning](https://arxiv.org/abs/2606.08735)
...
### [157] [Bridging Expert Knowledge and Automated Feature Engineering via Self-Evolution](https://arxiv.org/abs/2606.08800)
...
### [158] [Q-Delta: Beyond Key-Value Associative State Evolution](https://arxiv.org/abs/2606.08804)
...
### [159] [STAR: Rethinking MoE Routing as Structure-Aware Subspace Learning](https://arxiv.org/abs/2606.08814)
...
### [160] [Momentum for Reasoning: Dense Intrinsic Signals in Policy Optimization](https://arxiv.org/abs/2606.08815)
...
### [161] [Inference-Time Conformal Reasoning with Valid Factuality Control for Large Language Models](https://arxiv.org/abs/2606.08831)
...
### [162] [Instrumental convergence and power-seeking](https://arxiv.org/abs/2606.08832)
*David Thorstad*
...
### [163] [Beyond Pass Rate: A Multilingual, Execution-Grounded Evaluation of Open Code LLMs](https://arxiv.org/abs/2606.08840)
*Sayed Erfan Arefin*
...
### [164] [ZIPP:Zero-shot Image Personalization from Personas](https://arxiv.org/abs/2606.08841)
...
### [165] [A Resilience-as-a-Service assessment framework for coordinated disruption response in interdependent urban transit systems](https://arxiv.org/abs/2606.08849)
...
### [166] [Hybrid E-Assessment in Higher Education: Semi-Automated Grading of Paper-Based Written Examinations](https://arxiv.org/abs/2606.08855)
...
### [167] [Can the Environment Speak for Itself? $T^{2}$-GRPO: A Turn-Trajectory Group Relative Policy Optimization for Caregiver Agents](https://arxiv.org/abs/2606.08875)
...
### [168] [FAME: Forecastability-Aware Mixture of Experts for Heterogeneous Time Series Forecasting](https://arxiv.org/abs/2606.08896)
...
### [169] [Order Matters: Unveiling the Hidden Impact of Macro Placement Sequences via Proxy-Guided LLM Evolution](https://arxiv.org/abs/2606.08904)
...
### [170] [Oversight Has a Capacity: Calibrating Agent Guards to a Subjective, Fatiguing Human](https://arxiv.org/abs/2606.08919)
*Emre Turan*
...
### [171] [AlloSpatial: Agentic Harness Framework for Spatial Reasoning in Foundation Models](https://arxiv.org/abs/2606.08952)
...
### [172] [An Effective Router for Vision-Language Model Selection](https://arxiv.org/abs/2606.08970)
...
### [173] [Diverse Thinking Schemata Elicit Better Reasoning in Large Language Models](https://arxiv.org/abs/2606.08974)
...
### [174] [RTL-BenchLS: A Large-Scale Benchmark for RTL Reasoning and Generation with Large Language Models](https://arxiv.org/abs/2606.08976)
...
### [175] [Baichuan-M4: A Clinical-Grade Medical Agent System for Continuous Care](https://arxiv.org/abs/2606.08982)
...
### [176] [The Token Not Taken: Sampling, State, and the Variability of AI Agent Outputs](https://arxiv.org/abs/2606.08998)
...
### [177] [LATTEArena: An Evaluation Framework for LLM-powered Tabular Feature Engineering (Extended Version)](https://arxiv.org/abs/2606.09004)
...
### [178] [Personalization Meets Safety:Mechanisms,Risks,and Mitigations in Personalized LLMs](https://arxiv.org/abs/2606.09038)
...
### [179] [Agent Economics: An Entropy-Controlled Pluralistic Alignment Framework for Preventing Artificial Hivemind in Autonomous Agents](https://arxiv.org/abs/2606.09039)
*Cheonsu Jeong*
...
### [180] [REFLECT: Intervention-Supported Error Attribution for Silent Failures in LLM Agent Traces](https://arxiv.org/abs/2606.09071)
...
### [181] [DynaOD: Dynamic Origin-Destination Flow Generation with Discrete-to-Continuous Temporal Semantic Modeling](https://arxiv.org/abs/2606.09086)
...
### [182] [Graph2Idea:Retrieval-Augmented Scientific Idea Generation with Graph-Structured Contexts](https://arxiv.org/abs/2606.09105)
...
### [183] [ComplexConstraints and Beyond: Expert Rubrics for RLVR](https://arxiv.org/abs/2606.09118)
...
### [184] [A Regret Minimization Framework on Preference Learning in Large Language Models](https://arxiv.org/abs/2606.09124)
...
### [185] [Late-Layer Fusion is Enough: Dual-Path Vision Token Routing for Multimodal Large Language Models under Visual Saturation](https://arxiv.org/abs/2606.09131)
...
### [186] [Vision Language Model Helps Private Information De-Identification in Vision Data](https://arxiv.org/abs/2606.09132)
...
### [187] [Reliable to Expressive: A Curriculum for Rubric-Following Safety Judges](https://arxiv.org/abs/2606.09165)
...
### [188] [IMUG-Bench: Benchmarking Unified Multimodal Models on Interleaved Understanding and Generation](https://arxiv.org/abs/2606.09169)
...
### [189] [MASS: Deep Research for Social Sciences with Memory-Augmented Social Simulation](https://arxiv.org/abs/2606.09198)
...
### [190] [FF-JEPA: Long-Horizon Planning in World Models with Latent Planners](https://arxiv.org/abs/2606.09311)
...
### [191] [Anything2Skill: Compiling External Knowledge into Reusable Skills for Agents](https://arxiv.org/abs/2606.09316)
...
### [192] [TRL-Bench: Standardizing Cross-Paradigm Representation-Level Evaluation of Tabular Encoders](https://arxiv.org/abs/2606.09323)
...
### [193] [Leveraging Structural Constraints for Diffusion-based Neural TSP Solvers](https://arxiv.org/abs/2606.09343)
...
### [194] [Experience Makes Skillful: Enabling Generalizable Medical Agent Reasoning via Self-Evolving Skill Memory](https://arxiv.org/abs/2606.09365)
...
### [195] [Capability-Aligned Hierarchical Learning for Tool-Augmented LLMs](https://arxiv.org/abs/2606.09371)
...
### [196] [From Coarse to Fine: Managing Temporal Granularity in Spatio-Temporal Data for Fine-Grained Traffic Prediction](https://arxiv.org/abs/2606.09392)
...
### [197] [RunAgent SuperBrowser: A Theory of Autonomous Web Navigation Grounded in Human Browsing Behaviour](https://arxiv.org/abs/2606.09399)
...
### [198] [Correct Looks Better: Pairwise Comparisons Reveal Accuracy Rankings](https://arxiv.org/abs/2606.09409)
...
### [199] [Capacity, Not Format: Rethinking Structured Reasoning Failures](https://arxiv.org/abs/2606.09410)
*Hengxin Fan*
...
### [200] [WeaveBench: A Long-Horizon, Real-World Benchmark for Computer-Use Agents with Hybrid Interfaces](https://arxiv.org/abs/2606.09426)
...
### [201] [Bayesian Selective Latent Inference for Wastewater-First Influenza Monitoring](https://arxiv.org/abs/2606.09433)
...
### [202] [SIFT: Selective-Index For Fast Compute of RAG Prefill by Exploiting Attention Invariance](https://arxiv.org/abs/2606.09441)
...
### [203] [AliyunConsoleAgent: Training Web Agents in Real-World Cloud Environments via Distillation and Reinforcement Learning](https://arxiv.org/abs/2606.09447)
...
### [204] [TheoremBench: Evaluating LLMs on Theorem Proving in Formal Mathematics](https://arxiv.org/abs/2606.09450)
...
### [205] [Emergent alignment and the projectability of ethical personas](https://arxiv.org/abs/2606.09475)
...
### [206] [LLM-Orchestrated Conformance Checking in Stroke Care Without Computer-Interpretable Guidelines](https://arxiv.org/abs/2606.09489)
...
### [207] [Deterministic Integrity Gates for LLM-Assisted Clinical Manuscript Preparation: An Auditable Biomedical Informatics Architecture](https://arxiv.org/abs/2606.09500)
...
### [208] [From Rigid to Dynamic: Entropy-Guided Adaptive Inference for Long-Context LLMs](https://arxiv.org/abs/2606.09508)
...
### [209] [AI Scientists Are Only as Good as Their Evidence: A Stratified Ablation of Proprietary Data and Reasoning Skills in Drug-Asset Valuation](https://arxiv.org/abs/2606.09556)
*Yinan Wang*
...
### [210] [PRISM: Recovering Instruction Sets from Language Model Activations](https://arxiv.org/abs/2606.09563)
...
### [211] [Self-Explainability in Self-Adaptive and Self-Organising Systems: Status and Research Directions](https://arxiv.org/abs/2606.09568)
...
### [212] [Optical Reasoning: Rethinking Images as an Expressive Reasoning Medium Beyond Text](https://arxiv.org/abs/2606.09585)
...
### [213] [Next-Token Prediction Learns Generalisable Representations of Sleep Physiology](https://arxiv.org/abs/2606.09605)
...
### [214] [From 0-to-1 to 1-to-N: Reproducible Engineering Evidence for MetaAI Recursive Self-Design](https://arxiv.org/abs/2606.09663)
...
### [215] [Frequency-based Constrained Sampling for Interval Patterns](https://arxiv.org/abs/2606.09666)
...
### [216] [SpatialWorld: Benchmarking Interactive Spatial Reasoning of Multimodal Agents in Real-World Tasks](https://arxiv.org/abs/2606.09669)
...
### [217] [Correlation Is Not Enough: Embedding Human Metadata for Individual Causal Discovery](https://arxiv.org/abs/2606.09672)
...
### [218] [(Auto)formalization is supposed to be easy: Trellis process semantics for spelling out rigorous proofs](https://arxiv.org/abs/2606.09674)
*Wesley Pegden*
...
### [219] [Proxy Reward Internalization and Mechanistic Exploitation: A Learned Precursor to Reward Hacking and Its Generalization](https://arxiv.org/abs/2606.09711)
...
### [220] [Beyond Probabilistic Similarity: Structural, Temporal, and Causal Limitations of Retrieval-Augmented Generation in the Legal Domain](https://arxiv.org/abs/2606.09724)
*Hudson de Martim*
...
### [221] [SearchSwarm: Towards Delegation Intelligence in Agentic LLMs for Long-Horizon Deep Research](https://arxiv.org/abs/2606.09730)
...
### [222] [Multi-Turn Evaluation of Deep Research Agents Under Process-Level Feedback](https://arxiv.org/abs/2606.09748)
...
### [223] [Collaborative Human-Agent Protocol (CHAP)](https://arxiv.org/abs/2606.09751)
...
### [224] [SIGA: Self-Evolving Coding-Agent Adapters for Scientific Simulation](https://arxiv.org/abs/2606.09774)
...
### [225] [Evaluation Cards: An Interpretive Layer for AI Evaluation Reporting](https://arxiv.org/abs/2606.09809)
...
### [226] [Symbolic Reasoning Frameworks Modulate LLM Risk Aversion in Multi-Agent Strategic Settings](https://arxiv.org/abs/2606.07552)
*Augustin Chan*
...
### [227] [GRPO Does Not Close the Multi-Agent Coordination Gap](https://arxiv.org/abs/2606.07845)
...
### [228] [EduMirror: Modeling Educational Social Dynamics with Value-driven Multi-agent Simulation](https://arxiv.org/abs/2606.07948)
...
### [229] [Voting Protocols as Coordination Mechanisms for Role-Constrained Multi-Agent Tutoring Systems](https://arxiv.org/abs/2606.08030)
...
### [230] [Silent Failure in LLM Agent Systems: The Entropy Principle and the Inevitable Disorder of Autonomous Agents](https://arxiv.org/abs/2606.08162)
*Dexing Liu*
...
### [231] [Toward Human-Centered Multi-Agent Systems: Integrating Cognition, Culture, Values, and Cooperation in AI Agents](https://arxiv.org/abs/2606.08274)
...
### [232] [Emergence World: A Platform for Evaluating Long-Horizon Multi-Agent Autonomy](https://arxiv.org/abs/2606.08367)
...
### [233] [The Consistency Illusion: How Multi-Agent Debate Hides Reasoning Misalignment](https://arxiv.org/abs/2606.08457)
...
### [234] [Is Telehealth Better Used to Treat Patients or Help Other Physicians Treat Patients? An Agent-Based Modeling Study of Healthcare Provision](https://arxiv.org/abs/2606.08701)
*Michael Chary*
...
### [235] [Performance Evaluation of Social Learning](https://arxiv.org/abs/2606.09176)
...
### [236] [Quantifying Uncertainty in Space Debris Capture with Active Tether-Net Systems Caused by Noisy Observations](https://arxiv.org/abs/2606.07580)
...
### [237] [Koopman meets input-output data: Data-driven output-feedback control of nonlinear systems with closed-loop guarantees](https://arxiv.org/abs/2606.07758)
...
### [238] [Stability Without Safety: Gain Manipulation Attacks on Agentic Cyber-Physical Systems](https://arxiv.org/abs/2606.07803)
...
### [239] [CellSense: A Sub-6 GHz Cellular ISAC System for Clutter-Robust Passive Sensing](https://arxiv.org/abs/2606.07900)
...
### [240] [Extremum Seeking Control Based Adaptive Compensation of Position Sensor Harmonics in PMSM Drives](https://arxiv.org/abs/2606.07906)
...
### [241] [On Improved Statistical Accuracy of Low-Order Polynomial Chaos Approximations](https://arxiv.org/abs/2606.07912)
...
### [242] [Feedback Linearization and Control of a Grid-Forming Power Converter in an Islanded Microgrid](https://arxiv.org/abs/2606.07961)
...
### [243] [Multidimensional Resilience for Electrical Power Systems: Systematic Review, Integrated Index, and Validation under Real-World Cyber-Physical Attack Scenarios](https://arxiv.org/abs/2606.08062)
...
### [244] [When Can Phasor-Domain Device Models Be Trusted for Electromechanical Stability Analysis of Grid-Forming Converter-Dominated Microgrids?](https://arxiv.org/abs/2606.08082)
...
### [245] [A Global Convergence Analysis of Consensus ALADIN for Convex Optimization](https://arxiv.org/abs/2606.08112)
...
### [246] [A Barrier-Modulated Architecture for Safe Affine Formation Control in Second-Order Multi-Agent Systems](https://arxiv.org/abs/2606.08137)
...
### [247] [Risk-Aware Control of Systems with Quasi-Cone-Bounded Nonlinearities](https://arxiv.org/abs/2606.08208)
...
### [248] [Exact Optimization-Free Safety Filters for Control Barrier Functions](https://arxiv.org/abs/2606.08255)
*Ankit Goel*
...
### [249] [Benchmarking Sequential Feedback Optimization for Wind Farm Power Maximization](https://arxiv.org/abs/2606.08315)
...
### [250] [Predictive Coding with Bayesian Priors via Proximal Gradients](https://arxiv.org/abs/2606.08374)
*Francesco Bullo*
...
### [251] [Control-Theoretic View of Neural ODEs: Empirical Controllability and Observability](https://arxiv.org/abs/2606.08431)
...
### [252] [A Unified Framework for Contraction Stability Analysis of Heterogeneous Grid-Forming Inverters](https://arxiv.org/abs/2606.08434)
*Qianxi Tang,Li Peng*
...
### [253] [RadioDiff-Inv2: Differentiable Diffusion Inversion under Location Drift from Sparse Noisy Measurements for Radio Map Estimation](https://arxiv.org/abs/2606.08439)
...
### [254] [Revisiting mesoscopic traffic flow simulation in SUMO: Limitations, analysis, and an alternative](https://arxiv.org/abs/2606.09282)
...
### [255] [Bayesian Optimization of a Multi-Product Chemical Reactor Using Composite Models and Partial Physics Knowledge](https://arxiv.org/abs/2606.08611)
...
### [256] [Cooperative Guidance and Control for Active Asset Protection with Time-Varying Agent Speeds](https://arxiv.org/abs/2606.08636)
...
### [257] [Hybrid Neural Network and Conventional Controller Approach for Robust Control of Highly Unstable Systems: Application to Tilt-Rotor Control](https://arxiv.org/abs/2606.08714)
...
### [258] [Some Essential Constructive Foundations for Systems and Control](https://arxiv.org/abs/2606.08803)
*Pavel Osinenko*
...
### [259] [Energy Storage as a Multi-Use Asset: Applications Across the Power System](https://arxiv.org/abs/2606.08808)
*Fabrizio Sossan*
...
### [260] [Adaptive Model Predictive Control of Nonlinear Generic Urban Air Mobility Using Linear Parameter-Varying Systems](https://arxiv.org/abs/2606.08836)
*Tri Ngo*
...
### [261] [Direct Data-driven Predictive Control: A Computationally Efficient Alternative to DeePC for Eco-driving in Mixed Traffic Flows](https://arxiv.org/abs/2606.08880)
...
### [262] [Seamless Contraction-Control Framework for Unplanned Grid-Connected/Stand-Alone Transitions of Grid-Forming Inverters](https://arxiv.org/abs/2606.09042)
*Qianxi Tang,Li Peng*
...
### [263] [Families of Control-Cost-Parametrized Inverse-Optimal Universal Stabilizers](https://arxiv.org/abs/2606.09047)
...
### [264] [Modeling of Spinning Plates: Geometric Stiffening and Modal Approximation for GNC Applications](https://arxiv.org/abs/2606.09137)
...
### [265] [Advanced simulation framework for AC/MTDC power systems](https://arxiv.org/abs/2606.09406)
...
### [266] [Delayed Functional Observers for Output-Delayed Linear Systems](https://arxiv.org/abs/2606.09407)
*Hieu Trinh*
...
### [267] [Leveraging Optimal Information-Power Flow for Transmission Switching in AC/MTDC Grids](https://arxiv.org/abs/2606.09436)
...
### [268] [Tracking the Effective Surface Area of Non-Convex Satellites](https://arxiv.org/abs/2606.09439)
...
### [269] [Guaranteed Fast Implementation of the Split Covariance Intersection Filter: Nested Newton Method Thanks to the Fourth-Order Convexity of w-Optimization](https://arxiv.org/abs/2606.09505)
*Hao Li*
...
### [270] [A Continuification Approach to CAV Control in Mixed Traffic via Variable Speed Limits](https://arxiv.org/abs/2606.09534)
...
### [271] [Accelerating Birkhoff Projection for Manifold-Constrained Hyper-Connections](https://arxiv.org/abs/2606.07574)
...
### [272] [Large-Scale Regularized Matching on GPU Clusters](https://arxiv.org/abs/2606.07777)
...
### [273] [Cost-Aware Speculative Execution for LLM-Agent Workflows: An Integrated Five-Dimension Method](https://arxiv.org/abs/2606.07846)
*Faisal Fareed*
...
### [274] [FlashCP: Load-Balanced Communication-Efficient Context Parallelism for LLM Training](https://arxiv.org/abs/2606.08476)
...
### [275] [Unifying von-Neumann HPC and Neuromorphic Acceleration via the EBRAINS Research Infrastructure: A Framework for High-Performance Workflows](https://arxiv.org/abs/2606.08515)
...
### [276] [APEX4: Efficient Pure W4A4 LLM Inference via Intra-SM Compute Rebalancing](https://arxiv.org/abs/2606.08761)
...
### [277] [Aperon Technical Report: Hierarchical No-Pointer Tangent-Local Search for High-Dimensional Approximate Nearest Neighbors](https://arxiv.org/abs/2606.08813)
*Yong Fu*
...
### [278] [A Low-Latency Semantic State Estimator using Latent Predictive Learning for Dynamic Network Monitoring and Orchestration](https://arxiv.org/abs/2606.08869)
...
### [279] [When More Cores Hurts: The Vector Database Scaling Paradox in HPC](https://arxiv.org/abs/2606.08950)
...
### [280] [Fairness-Aware and Latency-Controllable Scheduling for Chunked-Prefill LLM Serving](https://arxiv.org/abs/2606.09061)
...
### [281] [Chimera: Protocol-Aware Recovery for Confidential BFT Consensus](https://arxiv.org/abs/2606.09101)
...
### [282] [Concepts in Practice: C++ MPI Bindings for the HPC Ecosystem. From a Standardizable Core to a Composable Interface](https://arxiv.org/abs/2606.09102)
...
### [283] [AutoPilot: Learning to Steer High Speed Robust BFT](https://arxiv.org/abs/2606.09120)
...
### [284] [Resource-aware Computation-Communication Overlap for multi-GPU ML Workloads](https://arxiv.org/abs/2606.09200)
...
### [285] [Engineering Scalable Distributed List Ranking](https://arxiv.org/abs/2606.09318)
...
### [286] [Coupling Complementary Simulations for Combined Performance and Energy Optimization](https://arxiv.org/abs/2606.09356)
...
### [287] [Parent-Hash DAG: A Cost Analysis of Constant-Time Append for On-Chain Registries](https://arxiv.org/abs/2606.09593)
...
### [288] [FMplex: Model Virtualization for Serving Extensible Foundation Models](https://arxiv.org/abs/2606.09643)
...
### [289] [PulseBench-Tab: A Multilingual Benchmark for Table Extraction with Graph-Based Evaluation](https://arxiv.org/abs/2606.07534)
...
### [290] [Bidirectional Semantic Complementary Tool Retrieval for Remote Sensing Agents](https://arxiv.org/abs/2606.07538)
...
### [291] [Beyond Item IDs: Scaling Short-Form-Video Recommendation via Semantic-Native Long Sequence Modeling](https://arxiv.org/abs/2606.07546)
...
### [292] [Evaluating Advanced Prompting on Gemini Flash for Multi-Hop Biomedical QA](https://arxiv.org/abs/2606.07548)
...
### [293] [MIRAGE: Metadata-Integrated Repository Analysis and Guided Enhancement for MSR Datasets](https://arxiv.org/abs/2606.07611)
...
### [294] [TRACER: Token ReAssignment for Concept ERasure in Generative Recommendation](https://arxiv.org/abs/2606.07688)
...
### [295] [ASH: Asymmetric Scalar Hashing With Learned Dimensionality Reduction for High-Fidelity Vector Quantization](https://arxiv.org/abs/2606.07870)
...
### [296] [OneFeed: A Unified Generative Framework for Feed Content Enhancement and Query Generation](https://arxiv.org/abs/2606.07972)
*Guo Xun*
...
### [297] [DeRes: Decoupling Residual Stability and Adaptivity for Scalable CTR Prediction](https://arxiv.org/abs/2606.07980)
...
### [298] [GIScholarBench: Benchmarking LLM Overconfidence in GIS Research](https://arxiv.org/abs/2606.08036)
...
### [299] [EmpiriGraph-Psy: A Dataset and LLM Pipeline for Extracting Empirical Relation Graphs from Psychology Abstracts](https://arxiv.org/abs/2606.08362)
...
### [300] [ToolRec: Calibrated Preference Alignment for Query Recommendation in On-Device Assistants](https://arxiv.org/abs/2606.08466)
...
### [301] [When Should Queries Be Decomposed? A Stage-Aware Study of Query Decomposition for Multi-Condition Retrieval](https://arxiv.org/abs/2606.08577)
...
### [302] [Gryphon: A Unified Architecture for Semantic-ID Generation and Item-Level Scoring in Industrial Recommendations](https://arxiv.org/abs/2606.08604)
...
### [303] [Report on CHIIR 2026 Workshop on Generative AI and Academic Search (GAI&AS)](https://arxiv.org/abs/2606.08936)
...
### [304] [EviProp: Seeded Relevance Diffusion on Chunk-Page Graphs for Long Multimodal Document Retrieval](https://arxiv.org/abs/2606.08979)
...
### [305] [Personal Salience: Highlighting Is Social, but Individuality Lives in Selection](https://arxiv.org/abs/2606.09024)
...
### [306] [Teach Multimodal Recommendation Model to See via Personalized Visual Extraction and Adaptive Learning](https://arxiv.org/abs/2606.09082)
...
### [307] [Closing the Indexing-Decoding Gap in Multimodal Generative Retrieval via Prefix Retention Optimization](https://arxiv.org/abs/2606.09241)
...
### [308] [Popcorn: A Configurable Benchmark for Visual Evidence in Multimodal Movie Recommendation](https://arxiv.org/abs/2606.09595)
