...
### [4] [Robustness and Leadership in Markov-switching Consensus Networks](https://arxiv.org/abs/2606.25888)
...
### [5] [Buildrix: An Open Platform for Sharing and Benchmarking Agentic AI Skills in Building Engineering](https://arxiv.org/abs/2606.25139)
...
### [6] [Active Learning for Optimal Experimental Design in Machine Learning-Based Building Energy System Identification](https://arxiv.org/abs/2606.25301)
...
### [7] [Conformal Recovery-Deadline Certificates for Runtime Assurance of Adapting Controllers](https://arxiv.org/abs/2606.25371)
*Alireza Shojaei*
...
### [8] [Control Barrier Function only Formation Tracking in Multi-Agent Systems](https://arxiv.org/abs/2606.25452)
...
### [9] [Reference-Free Heterogeneous Multi-Agent Reinforcement Learning for Grid-Friendly Tie-Line Power Shaping in Industrial Microgrids](https://arxiv.org/abs/2606.25599)
...
### [19] [Power-Flexible AI Data Centers: A New Paradigm for Grid-Responsive Compute](https://arxiv.org/abs/2606.25098)
...
### [20] [Information from coincidences](https://arxiv.org/abs/2606.25042)
*Akshay Balsubramani*
...
### [21] [Wideband Near-Field Channel Estimation Under Hybrid Compression: Cross-Subcarrier KL Covariance Fitting With OFDM Fresnel Model](https://arxiv.org/abs/2606.25101)
...
### [22] [Inner and Outer Bounds on the Secrecy Capacity of Degraded Broadcast Channels with RMSI and Transmitter CSI](https://arxiv.org/abs/2606.25351)
...
### [23] [OAMP-Aided Joint Channel Estimation and Data Detection for ODDM Systems](https://arxiv.org/abs/2606.25420)
...
### [24] [Center-Fed Pinching Antenna System for Uplink Environment Sensing](https://arxiv.org/abs/2606.25423)
...
### [25] [A Path-Survival Analytical Framework for SCL Decoding of Polar Code](https://arxiv.org/abs/2606.25522)
...
### [26] [Interplay between VAoI, Packet Error Rate, and Delay for Energy-Efficient Remote Monitoring](https://arxiv.org/abs/2606.25566)
...
### [27] [The Condition for Structured Coding to Improve Random Coding in the Binary Modulo-sum Problem](https://arxiv.org/abs/2606.25570)
...
### [28] [Performance Analysis for Heterogeneous Air-Ground ISAC in Coordinated Multipoint Networks](https://arxiv.org/abs/2606.25574)
...
### [29] [The MDS or NMDS for Modified GRS codes with flexible hull dimensions and lengths](https://arxiv.org/abs/2606.25662)
...
### [30] [MAP-Based Task-Oriented Precoding for Multiuser Communication](https://arxiv.org/abs/2606.25722)
...
### [31] [Agentic Knowledge Tracing: A Multi-Agent LLM Architecture for Stealth Assessment of Financial Literacy in Serious Games](https://arxiv.org/abs/2606.25358)
...
### [32] [Agentic evolution of physically constrained foundation models](https://arxiv.org/abs/2606.25532)
...
### [33] [The Hitchhiker's Guide to Agentic AI: From Foundations to Systems](https://arxiv.org/abs/2606.24937)
*Haggai Roitman*
...
### [34] [Bridging the Post-discharge Gap: A Traceable Multi-agent Framework for Safe and Continuous Care](https://arxiv.org/abs/2606.25334)
...
### [35] [Rate-Aware Quantum-Inspired Trajectory Learning for Interference-Limited Multi-UAV Networks](https://arxiv.org/abs/2606.25480)
...
### [36] [Manipulation Is Task-Dependent: A Multi-Axis, Multi-Environment Evaluation of Frontier LLMs](https://arxiv.org/abs/2606.25899)
...
### [37] [Multi-Agent Goal Recognition with Team- and Goal-Conditioned Reinforcement Learning and Factorized Branch-and-Bound](https://arxiv.org/abs/2606.25978)
...
### [38] [Minimization of a One Class of Maximum Functions with Applications to Some Eigenvalue Problems](https://arxiv.org/abs/2606.25106)
...
### [39] [Sums of squares in polynomial time](https://arxiv.org/abs/2606.25118)
...
### [40] [Structured Spectral Step-Sizes and a Hanoi Ordering Principle for Gradient Methods](https://arxiv.org/abs/2606.25311)
*Yijia Zhou,Ran Gu*
...
### [41] [Deterministic Non-Smooth Safety via Dual-Algebraic Control Barrier Functions](https://arxiv.org/abs/2606.25333)
...
### [42] [Primal-Dual Halpern-PAGE Algorithm for Constrained Stochastic Weakly Convex Optimization](https://arxiv.org/abs/2606.25355)
...
### [43] [Learning Optimization Proxies for Sequential Contextual Stochastic Programs: An Order Fulfillment Application](https://arxiv.org/abs/2606.25362)
...
### [44] [Formalization of Line Search Methods by Lean](https://arxiv.org/abs/2606.25412)
...
### [45] [Equilibrium singular dividend control under ambiguity aggregation of heterogeneous discount rates](https://arxiv.org/abs/2606.25461)
...
### [46] [Generalized convexity of spectral functions on Euclidean Jordan algebras](https://arxiv.org/abs/2606.25507)
*Juyoung Jeong*
...
### [47] [Parallel Dynamic Programming for Conic Linear Quadratic Control](https://arxiv.org/abs/2606.24632)
...
### [48] [Convergence of the Safeguarded Augmented Lagrangian Method under the Polyak-Lojasiewicz constraint qualification for Constrained Composite Optimization](https://arxiv.org/abs/2606.25567)
...
### [49] [Proximity operator characterization for abstract convex functions](https://arxiv.org/abs/2606.25614)
...
### [50] [Robust Multi-step Model Predictive Control with Feasibility Guarantees](https://arxiv.org/abs/2606.25684)
...
### [51] [Pontryagin-Based Solver with Smoothed Hamiltonian, Adaptive $Δt$, and PA-Bundle Refinement](https://arxiv.org/abs/2606.25731)
...
### [52] [Convergence analysis of the Riemannian proximal gradient method with inexact oracle](https://arxiv.org/abs/2606.25764)
...
### [53] [Generating Input Distributions for Explaining Portfolio Optimization Pipelines](https://arxiv.org/abs/2606.25808)
...
### [54] [A Methodology for Integrating Life Cycle Assessment into a Multidisciplinary Design Analysis and Optimization Framework for Sustainable Launcher Development](https://arxiv.org/abs/2606.25945)
...
### [55] [A $\operatorname{prox}$-Based Semi-Smooth Newton Method for Convex Variational Problems](https://arxiv.org/abs/2606.25948)
...
### [56] [Dominance-Based Feasibility Inference for Packing-Constrained Pickup and Delivery Problems](https://arxiv.org/abs/2606.25970)
...
### [57] [Toward a Systematic Understanding and Interactive Search of Lyapunov-Style Proofs in Optimization](https://arxiv.org/abs/2606.26077)
