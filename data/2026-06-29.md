...
### [7] [Agent-Native Immune System: Architecture, Taxonomy, and Engineering](https://arxiv.org/abs/2606.28270)
...
### [26] [Access Selection for Finite-SNR Modal Recoverability in Sampled-Wave Receivers](https://arxiv.org/abs/2606.27461)
...
### [27] [Electronically Reconfigurable Pinching Antennas for Millimeter-Wave Communication in LoS and NLoS Environments](https://arxiv.org/abs/2606.27471)
...
### [28] [LightFARM: Model Predictive Lighting Control with Battery-Free IoT for Energy-Efficient Indoor Farming](https://arxiv.org/abs/2606.27649)
...
### [29] [Distributed Air-Gap Flux and Rotor-Current Fusion for Operating-Regime Identification in a 10-MW Kaplan Hydrogenerator](https://arxiv.org/abs/2606.27800)
...
### [30] [A Beamforming Microwave Interferometric Radiometer for High-resolution Passive Imaging: Concept, Modeling, and Preliminary Demonstration](https://arxiv.org/abs/2606.27970)
...
### [31] [Optimized Beamforming and Bandwidth Allocation in Multi-Antenna UAV-Assisted Vehicular Networks](https://arxiv.org/abs/2606.28046)
...
### [32] [An Enhanced Source-Free Unsupervised Domain Adaptation Framework for Cross-Dataset EEG Emotion Recognition via Predictive Coding and Test-Time Training](https://arxiv.org/abs/2606.28202)
...
### [33] [Comparison of Non-Deterministic Nonlinear Systems](https://arxiv.org/abs/2606.27464)
...
### [34] [Threshold Optimization and Dynamic Adaptation of Distributed Optimal Power Flow in 5G Networks](https://arxiv.org/abs/2606.27542)
...
### [35] [Real-Time State Estimation in Smart Grids over 5G Networks: Experimental Validation Using Raspberry Pis and Typhoon HIL](https://arxiv.org/abs/2606.27642)
...
### [37] [A Bi-Layer TSN Formulation for Separable Scheduling of Mobile Emergency Resources](https://arxiv.org/abs/2606.27712)
...
### [38] [Bearing-based Circumnavigation with Collision Avoidance in Time-varying Graphs under Limited Target Information](https://arxiv.org/abs/2606.27719)
...
### [39] [Repair-before-veto control for safe lithium-ion fast charging under unknown ambient and cooling-fault conditions](https://arxiv.org/abs/2606.27781)
*Yifan Wang*
...
### [40] [From Detection to Action: Using LLM Agents for Fault-Tolerant Control](https://arxiv.org/abs/2606.28011)
...
### [41] [Decentralized Stability of IBR-dominated Power Grids Using Block Diagonal Dominance](https://arxiv.org/abs/2606.28023)
...
### [42] [Effects of motion cueing on longitudinal acceleration perception in a driving simulator](https://arxiv.org/abs/2606.28055)
...
### [43] [Specification-aware Robustness Margins for Symbolic Controllers](https://arxiv.org/abs/2606.28143)
...
### [44] [PAC-Bayesian Certificates for Quadratic Closed-Loop Control](https://arxiv.org/abs/2606.28281)
*Domagoj Herceg*
...
### [45] [On strongly quasiconvex pseudomonotone equilibrium problems in Hadamard spaces](https://arxiv.org/abs/2606.27563)
...
### [46] [Uncertainty-aware Power System Planning via Gradient Descent](https://arxiv.org/abs/2606.27602)
...
### [47] [Policy Gradient Learning for Distributionally Robust Markov Decision Processes under Wasserstein Ambiguity](https://arxiv.org/abs/2606.27610)
...
### [48] [Multidimensional quadratic BSDEs with weak interactions and their applications in mean-field games of controls](https://arxiv.org/abs/2606.27640)
...
### [49] [A Backstepping Framework for Unconstrained Accelerated Optimization Algorithms](https://arxiv.org/abs/2606.27722)
...
### [50] [A primal-dual splitting algorithm for monotone inclusions with applications](https://arxiv.org/abs/2606.28010)
...
### [51] [Fractional quadratic obstructions to the local controllability of the Burgers equation](https://arxiv.org/abs/2606.28106)
*Thomas Perrin*
...
### [52] [Reservoir Zero-Coordinatewise Projected Subspace Search for Minimization Over Sparse Symmetric Sets in Machine Learning](https://arxiv.org/abs/2606.28124)
...
### [53] [Three-Body Earth-Moon Transfers with Different Departure/Arrival Orbital Altitudes: New Phenomenon and Diffusion Model-Augmented Construction](https://arxiv.org/abs/2606.28207)
...
### [54] [A Fletcher's Augmented Lagrangian-Based Stochastic First-Order Method for Nonconvex Equality-Constrained Optimization](https://arxiv.org/abs/2606.28230)
...
### [55] [Graphon Mean Field Game of mutual holding](https://arxiv.org/abs/2606.28254)
...
### [56] [Sharp First-Order Lower Bounds under Sublevel $α$-Polyak-Lojasiewicz Conditions](https://arxiv.org/abs/2606.28278)
...
### [57] [Second-Order KKT Guarantees for Bregman ADMM in Nonconvex and Non-Lipschitz Optimization](https://arxiv.org/abs/2606.28307)
...
### [58] [SidConArena: An Environment Evaluating Agents in Open-Ended,Positive-Sum Bargaining Game](https://arxiv.org/abs/2606.27397)
...
### [59] [Delayed Verification Destabilizes Multi-Agent LLM Belief: Instability Thresholds and Optimal Corrector Placement](https://arxiv.org/abs/2606.27409)
*Igor Itkin*
...
### [60] [Glite ARF: Verifier-Driven Research with Parallel LLM Coding Agents](https://arxiv.org/abs/2606.27416)
...
### [61] [QueenBee Planner: Skill-Evolving Communication Topologies for Token-Efficient LLM Multi-Agent Systems](https://arxiv.org/abs/2606.27492)
...
### [62] [GenWorld: Empirically Grounded Urban Simulation Infrastructure for Scalable LLM-Agent Studies](https://arxiv.org/abs/2606.27650)
...
### [63] [GBC: Gradient-Based Connections for Optimizing Multi-Agent Systems](https://arxiv.org/abs/2606.28187)
...
### [64] [A Quantum Method of Types](https://arxiv.org/abs/2606.27442)
*Arick Grootveld*
...
### [65] [Deriving Approximate Message Passing from the Convex Gaussian Min-Max Theorem](https://arxiv.org/abs/2606.27769)
...
### [66] [Constructions and Characterizations of $s$-Plateaued Partitions](https://arxiv.org/abs/2606.27776)
...
### [67] [Differential Privacy over Hamming Codes](https://arxiv.org/abs/2606.27849)
...
### [68] [Performance Analysis and Optimal Design of ORB-Type GRAND Algorithms](https://arxiv.org/abs/2606.28030)
*Li Wan,Wenyi Zhang*
...
### [69] [A Sensitivity-Aware Test Collection for Search Among Personal Information](https://arxiv.org/abs/2606.27559)
...
### [70] [Intuition-Guided Latent Reasoning for LLM-Based Recommendation](https://arxiv.org/abs/2606.27684)
...
### [71] [Bifocal Diffusion Language Models: Asymmetric Bidirectional Context for Parallel Generation](https://arxiv.org/abs/2606.27732)
...
### [72] [End-to-End Dynamic Sparsity for Resource-Adaptive LLM Inference](https://arxiv.org/abs/2606.27743)
...
### [73] [From Bootstrapping to Sequence Modeling: A Unified Generative Framework for Personalized Landing-Page Modeling](https://arxiv.org/abs/2606.27865)
...
### [74] [An LLM-Powered Semantic Alignment Framework for Journal Recommendation](https://arxiv.org/abs/2606.27930)
...
### [75] [Listwise Explanation of Embedding-Based Rankings via Semantic Chunk Grouping](https://arxiv.org/abs/2606.27980)
...
### [76] [Fast and Feasible: Permutation-based Constrained Reranking for Revenue Maximization](https://arxiv.org/abs/2606.28059)
