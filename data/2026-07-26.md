...
### [8] [Lightweight Gated Recurrent Unit Variants for Real-Time Channel Prediction](https://arxiv.org/abs/2607.20697)
...
### [9] [Near-Field Sampling for Line Sources](https://arxiv.org/abs/2607.20701)
...
### [10] [Self-Attention Transformer-Based Detector for Faster-than-Nyquist Signaling](https://arxiv.org/abs/2607.20745)
...
### [11] [RadioTrace: Transmitter-Aware Diffusion for Radio Map Estimation without Deployment-Time Fine-Tuning](https://arxiv.org/abs/2607.20909)
...
### [12] [Decoding Parkinsonian Tremor: An Explainable Framework Integrating Multi-Revolution Spatial and Spectral Dynamics of Spiral Drawings](https://arxiv.org/abs/2607.20930)
...
### [13] [Beyond Point Targets: Experimental Analysis of Frequency Anisotropy for Multi-band ISAC in FR3](https://arxiv.org/abs/2607.20994)
...
### [14] [Quantifying Event-Related (De)Synchronization Variability for Brain-Computer Interface: A Unified and Interpretable Framework](https://arxiv.org/abs/2607.21119)
...
### [15] [Automated Full-Sphere Measurement Methodology for Reconfigurable Intelligent Surface Beam Steering in an Anechoic Chamber](https://arxiv.org/abs/2607.21235)
...
### [16] [Constellation Selection and Power Allocation for Multi-Cell OFDM-ISAC: Managing Inter-Cell Interference and Sensing Sidelobes](https://arxiv.org/abs/2607.21418)
...
### [17] [Toward Generalizable Cognitive Impairment Detection with Speech-Based Multimodal Large Language Models](https://arxiv.org/abs/2607.21496)
...
### [18] [Human-Aware Power Restoration for Fair Outage Experience in Distribution Systems](https://arxiv.org/abs/2607.20580)
...
### [19] [Robust Adaptive Backup Control Barrier Functions](https://arxiv.org/abs/2607.20842)
...
### [20] [Interaction Dynamics Modeling and Predictive Control for Safe Steerable Catheter--Tissue Interaction](https://arxiv.org/abs/2607.20939)
*Yongyan Cao*
...
### [21] [Supervisory Control with Event Forcing Under Partial Observation](https://arxiv.org/abs/2607.21040)
*Yin Tong,Kai Cai*
...
### [22] [A scalable and resource-efficient pipelined p-computer for probabilistic Ising machines](https://arxiv.org/abs/2607.21077)
...
### [23] [Certified Stochastic Control via Covariance Steering with Pick-to-Learn](https://arxiv.org/abs/2607.21086)
...
### [24] [Semi-Explicit Solutions to the Prying-Pedestrian Surveillance-Evasion Differential Game and Extensions to Two Pursuers](https://arxiv.org/abs/2607.21087)
...
### [25] [Safety and Security: Experimental Validation of Encrypted Model Predictive Control](https://arxiv.org/abs/2607.21136)
...
### [26] [Deep Reinforcement Learning for Adaptive Gain Tuning in Control of Teleoperation Manipulators with Joint Flexibility and Time-Varying Delays](https://arxiv.org/abs/2607.21145)
...
### [27] [When Persistency is not Exciting in Data-Driven Predictive Control](https://arxiv.org/abs/2607.21280)
...
### [28] [Interoperability of Electric Drive Models using HELICS](https://arxiv.org/abs/2607.21486)
*Ajay Pratap Yadav*
...
### [29] [Through-the-Earth Magnetic Induction Communication and Networking: A Comprehensive Survey](https://arxiv.org/abs/2510.14854)
...
### [30] [First-Order Analysis of Optimization in Uniformly Convex Metric Spaces: Directional Subderivatives and Basic Descent](https://arxiv.org/abs/2607.20677)
...
### [31] [Rule-Induced Behavior of Fuzzy Scalar Objective Functions for Reliable Multi-Criteria Decision Making](https://arxiv.org/abs/2607.20731)
*Olaf Frommann*
...
### [32] [A Safeguarded Projected-Gradient Framework for Complementarity-Constrained Least-Squares Problems](https://arxiv.org/abs/2607.20786)
...
### [33] [Mean field and N-agent games for optimal relative consumption-investment with jump risk and common noise](https://arxiv.org/abs/2607.20845)
...
### [34] [Structure-Preserving Spectral Dynamic Programming on Compact Lie Groups](https://arxiv.org/abs/2607.20854)
...
### [35] [Implicit Primal-Dual Guarantees in Unconstrained First-Order Minimization](https://arxiv.org/abs/2607.20875)
...
### [36] [Learning to recover: Adaptive local branching with reinforcement learning for log-truck routing and scheduling under disruptions](https://arxiv.org/abs/2607.20901)
...
### [37] [Boundary control and periodic trajectories of semilinear Euler equations with application to hydrogen transport](https://arxiv.org/abs/2607.20948)
...
### [38] [Dynamic Cloud Service-Capacity Deployment with Costly Response Readiness](https://arxiv.org/abs/2607.20961)
...
### [39] [Control Co-design of systems with parabolic PDE dynamics](https://arxiv.org/abs/2607.20975)
...
### [40] [Stabilization of 1D Linear Hyperbolic Balance Laws by Integral Difference Control and Application to Networks Stabilization](https://arxiv.org/abs/2607.21060)
...
### [41] [Exact ensemble controllability for neural differential equations via neural interpolation](https://arxiv.org/abs/2607.21112)
*Martin Gugat*
...
### [42] [A Gaussian smoothing-based zeroth-order method for Goldstein second-order stationarity](https://arxiv.org/abs/2607.21258)
...
### [43] [Fokker-Planck-Kolmogorov inclusions of the mean field type](https://arxiv.org/abs/2607.21297)
*Yurii Averboukh*
...
### [44] [Decomposing a Multi-Scale Optimization Framework for Grid-Integrated Electrolysis using Aggregate-Informed Benders](https://arxiv.org/abs/2607.21440)
...
### [45] [Climate-resilient electric vehicle charging infrastructure for sustainable cities: An interpretable causal-ensemble framework for preventive maintenance and low-carbon mobility](https://arxiv.org/abs/2607.21444)
...
### [46] [Asymptotic Analysis of Empirical Dynamic Programming in Infinite-Horizon Stochastic Optimal Control](https://arxiv.org/abs/2607.21520)
...
### [47] [Barzilai-Borwein Fails Superlinear Convergence on an Open Set of Quadratics for Every Dimension $n\geq 4$](https://arxiv.org/abs/2607.21579)
...
### [48] [pAI-Econ-claude: A Gated Human-in-the-Loop Multi-Agent Architecture for AI-Assisted Economic Theory Development](https://arxiv.org/abs/2607.21268)
...
### [49] [FedAgentKE: Federated Semantic Knowledge Evolution for Heterogeneous Agents](https://arxiv.org/abs/2607.21361)
...
### [50] [Pipelined Gradient Coding](https://arxiv.org/abs/2607.20739)
*Xian Su,Jun Li*
...
### [51] [New Criteria and Constructions for Self-Orthogonal Codes](https://arxiv.org/abs/2607.20805)
...
### [52] [Weak Private Information Retrieval for Graph-based Storage](https://arxiv.org/abs/2607.21014)
...
### [53] [Construction and Dynamic Update of Channel Gain Maps via 3D Gaussian Splatting](https://arxiv.org/abs/2607.21099)
...
### [54] [Electromagnetic-Aware Fluid Antenna Array](https://arxiv.org/abs/2607.21375)
...
### [55] [Improved lower bounds for the Shannon capacity of odd cycles](https://arxiv.org/abs/2607.21517)
...
### [56] [PortLBM: A Portable Lattice Boltzmann Tool Leveraging SYCL on AMD, NVIDIA, and Intel GPUs](https://arxiv.org/abs/2607.20650)
...
### [57] [A Framework for Reputation Aware Uninorm-driven Consensus Algorithms for Blockchain Networks](https://arxiv.org/abs/2607.20700)
...
### [58] [The Consensus Number of Untraceable Cryptocurrencies](https://arxiv.org/abs/2607.20929)
...
### [59] [Multimmit: Extending Blocks for Faster Finality](https://arxiv.org/abs/2607.21021)
...
### [60] [Solving Large Traveling Salesman Problems (TSPs) by a Recursive Clustering Algorithm and a Scalable FPGA-Based Implementation](https://arxiv.org/abs/2607.21182)
...
### [61] [Controlled Periodic Synchronization for Efficient Data-Parallel Training](https://arxiv.org/abs/2607.21224)
...
### [63] [Marking the Wrong Symptoms: Evaluating LLM Watermarks in Medical Texts](https://arxiv.org/abs/2607.20462)
...
### [64] [Workload-Aware Caching for Multi-Agent Systems](https://arxiv.org/abs/2607.20495)
...
### [65] [ClickGuard: Detecting and Spoiling Clickbait News with Informativeness Measures and Large Language Models](https://arxiv.org/abs/2607.20463)
...
### [66] [MKEvolve: A Modular Multi-Agent Framework for Kernel Code Generation](https://arxiv.org/abs/2607.20501)
...
### [67] [Stochastic Sampling is Epistemically Shallow: The Dimensionality Gap Between Temperature Variation and Model Diversity in LLMs](https://arxiv.org/abs/2607.20464)
*Izhar Ali*
...
### [68] [Agentic Context Management: Solving Agent Memory and Cost by Treating Them as Lifecycle and Architecture Problems](https://arxiv.org/abs/2607.21503)
*Gaurav Dadhich*
...
### [69] [AppWorld-UL: Benchmarking Diverse Agent-User Interactions for Tool-Use](https://arxiv.org/abs/2607.20536)
...
### [70] [JAXBench: Benchmarking Autonomous TPU Kernel Optimization](https://arxiv.org/abs/2607.20466)
...
### [71] [HiMe: Real-Time Self-Hosted Personal Agent Platform for Health Insights with Wearable Devices](https://arxiv.org/abs/2607.21019)
...
### [72] [DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding](https://arxiv.org/abs/2607.20467)
...
### [73] [SafeStep: AI-powered Travel Assistance for Elderly People with Frailty or Dementia](https://arxiv.org/abs/2607.21156)
...
### [74] [CRAWO: Custom Resources for Adaptive Workload Orchestration](https://arxiv.org/abs/2607.20490)
...
### [76] [Toward Continuous Assurance for the Democratization of AI Agent Creation in Industry](https://arxiv.org/abs/2607.21495)
...
### [77] [DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions](https://arxiv.org/abs/2607.20469)
...
### [78] [The Boundaries of Automation: A Theory of Persistent Human Participation](https://arxiv.org/abs/2607.21547)
...
### [80] [PlanE: Meta Planning of Data, Tuning, and Inference for Extractive-based LLMs](https://arxiv.org/abs/2607.20470)
...
### [81] [Benchmarking the Personalization Capabilities of Large Language Models](https://arxiv.org/abs/2607.20471)
...
### [82] [Robust Critics: Defending LLMs Against Multi-Turn Attacks](https://arxiv.org/abs/2607.20472)
...
### [84] [An LLM-Driven Workflow for Automated Process Control Strategy Generation and Tuning from Dynamic Process Models](https://arxiv.org/abs/2607.21292)
...
### [100] [DFAH-Bench: Benchmarking Observable Agent Instability in Financial Decision-Making](https://arxiv.org/abs/2607.20491)
...
### [101] [Attention-based Experience Replay Framework for Continual Learning of Agnostic Time Series Forecasting Models](https://arxiv.org/abs/2607.20493)
...
### [102] [Isolating LLM Alignment from Regex: Zero Coverage and Metric-Dependent Divergence Under Adversarial Mutation](https://arxiv.org/abs/2607.20494)
...
### [103] [From Errors to Rules: Iterative Prompt Optimization for Text Classification](https://arxiv.org/abs/2607.20497)
...
### [104] [AISE-Bench: A Full-Cycle Curated Benchmark for Information Seeking on Academic Knowledge Graphs](https://arxiv.org/abs/2607.20498)
...
### [105] [ExecuGraph: A Multi-Agent, Execution-Grounded Framework for Reliable Backend Code Synthesis with Large Language Models](https://arxiv.org/abs/2607.20499)
...
### [106] [FlowEdit: Information-Theoretic Control of LLM Reasoning Flows for Ill-posed Problems Involving Conflicts](https://arxiv.org/abs/2607.20500)
...
### [107] [Inducing Comparability of Factorised Probability Distributions](https://arxiv.org/abs/2607.20502)
...
### [108] [LeanFlow: A Case Study in Workflow-Driven Lean Autoformalization](https://arxiv.org/abs/2607.20503)
...
### [109] [Optimizing Hypergraph-Based RAG: Toward Better Fact Extraction and Chunk Retrieval](https://arxiv.org/abs/2607.20506)
...
### [110] [MiniCache: Reusable Program Caching with Small Model Interfaces for Efficient LLM Inference](https://arxiv.org/abs/2607.20507)
...
### [111] [Telco-GAIA: Bilingual Benchmark for Agents in Telecom Domain](https://arxiv.org/abs/2607.20510)
...
### [112] [SiGMA: Sign-Guided Merging and Adaptation for Multimodal Continual Instruction Tuning](https://arxiv.org/abs/2607.20511)
...
### [113] [Reliability-Aware LLM Alignment from Inconsistent Human Feedback](https://arxiv.org/abs/2607.20515)
...
### [114] [CANN Bench: Benchmarking Agent Generated Kernels against Real NPU and Algorithmic Limits](https://arxiv.org/abs/2607.20518)
...
### [115] [Representation Robustness Under Executable Reasoning Constraints in Large Language Models for Mathematical Problem Solving](https://arxiv.org/abs/2607.20520)
...
### [116] [Attention Degradation, Function Token Anchoring, and the Limits of Attention-Based Intervention in Large Language Models](https://arxiv.org/abs/2607.20524)
...
### [117] [Autonomous disproofs of the sum-product conjecture over $\mathbb R$ with GPT-5.5 Pro](https://arxiv.org/abs/2607.20525)
*Yichen Huang*
...
### [118] [ConfidenceBench: Evaluating Confidence Calibration in Large Language Models](https://arxiv.org/abs/2607.20526)
...
### [119] [Evaluating and Guarding Citation Faithfulness in Agentic Scientific Synthesis](https://arxiv.org/abs/2607.20527)
...
### [120] [PromptPack: Scaling LLM Annotation Agents for Online Recommendation](https://arxiv.org/abs/2607.20528)
...
### [121] [DynamicMCPBench: A Trace-Grounded, Effect-Scored Benchmark for LLM Agents over Live MCP Servers](https://arxiv.org/abs/2607.20531)
...
### [122] [StrideDiffusion: Accelerating Diffusion Models for Time-series Generation](https://arxiv.org/abs/2607.20545)
...
### [123] [CMI-Mem: Toward Generalizable Long-Term Memory Management via CMI-Augmented Reinforcement Learning](https://arxiv.org/abs/2607.20553)
...
### [124] [AI-Driven Multi-Hop Relay Selection for Smart Urban NR-V2X Networks via Learning-to-Optimize Graph Neural Networks](https://arxiv.org/abs/2607.20554)
...
### [125] [KeySI: An Interaction Framework for Tuning Text Embeddings Based on Human Feedback](https://arxiv.org/abs/2607.20556)
...
### [126] [WaveformQA: Benchmarking LLM Temporal Reasoning on Digital Waveforms](https://arxiv.org/abs/2607.20638)
...
### [127] [NVIDIA-labs OO Agents: Native Python Object-Oriented Agents](https://arxiv.org/abs/2607.20709)
...
### [128] [ArbiGraph: Arbitrarily Scalable Verifiable Task Graphs for Evaluating Context Management](https://arxiv.org/abs/2607.20764)
...
### [129] [The Human-AI Substitution Principle: When will you be replaced by AI in your organization?](https://arxiv.org/abs/2607.20781)
...
### [130] [Refusal-Gated Decoding: Preserving Refusal Behavior Under High-Temperature Sampling](https://arxiv.org/abs/2607.20791)
...
### [131] [Can an AI System Be Creative? A Critical Perspective from Art and Engineering](https://arxiv.org/abs/2607.20796)
...
### [132] [Profiling Lightweight Large Language Models](https://arxiv.org/abs/2607.20806)
...
### [133] [Enhancing Explainable Cardiac Diagnosis with Guide-Grounded Multimodal LLMs](https://arxiv.org/abs/2607.20814)
...
### [134] [Efficient and Interpretable Body-Based Emotion Recognition with Lightweight Temporal Convolutional Networks](https://arxiv.org/abs/2607.20820)
...
### [135] [Auditing Provenance Sensitivity in LLM Agent Action Selection](https://arxiv.org/abs/2607.20827)
*Junchi Liao*
...
### [136] [Auditing Evidence Use in Medical LLM Diagnosis](https://arxiv.org/abs/2607.20848)
...
### [137] [Code Monitor Red Teaming for Public-Test-Passing Code](https://arxiv.org/abs/2607.20852)
*Junchi Liao,Jiawen Deng,Fuji Ren*
...
### [138] [Is Deep Research Reliable? Misleading Knowledge Induces False Conclusions](https://arxiv.org/abs/2607.20891)
...
### [139] [Source-Prior-Driven Selective Adaptation for Efficient Diffusion Model Finetuning](https://arxiv.org/abs/2607.20913)
...
### [141] [OPOD: On-Policy Omni Distillation](https://arxiv.org/abs/2607.20918)
...
### [142] [Representing Entity Importance in AI Knowledge Systems: A Dual-Signal Framework of Audience Evaluation and Structural Authority](https://arxiv.org/abs/2607.20925)
*Shen Xu*
...
### [143] [SciExplore: Evaluating Autonomous Agents from Scientific Navigation to Information Integration](https://arxiv.org/abs/2607.20926)
...
### [144] [From Scalars to Time Series: Rethinking Implicit Neural Representations for Time-Varying Volumetric Data](https://arxiv.org/abs/2607.20970)
...
### [145] [Delivery, Not Storage: Cue-Anchored Working Memory as a Harness Property for Coding Agents](https://arxiv.org/abs/2607.20972)
*Swapnanil Saha*
...
### [146] [Beyond Independent Optimization: Compression, MoE Routing, and Quantization Interactions in Multimodal Edge Intelligence](https://arxiv.org/abs/2607.20981)
...
### [147] [GuardianAgentBench: Where Agents Fail and How to Guard Them](https://arxiv.org/abs/2607.20982)
...
### [148] [Workflow-Localized Mechanism Learning: Attribution-Guided Repair and Knowledge Reuse for Structured Agent Skills](https://arxiv.org/abs/2607.20999)
...
### [149] [Naju: A Native Discrete State-Space Model with Independent Retention and Writing for Long-Sequence Memory](https://arxiv.org/abs/2607.21000)
...
### [150] [Reexamining zero-shot summarization: Empirical investigation of trustworthiness of LLM-summarizers](https://arxiv.org/abs/2607.21010)
...
### [151] [EmoAgent-R1: Towards Multimodal Emotion Understanding with Reinforcement Learning-based Dynamic Agent Specialization](https://arxiv.org/abs/2607.21013)
...
### [152] [Faster IndexTTS-2: Accelerating and Streaming Autoregressive Zero-Shot Text-to-Speech Synthesis on GPUs](https://arxiv.org/abs/2607.21042)
...
### [153] [Can Generative Recommendation Reach Cold Items? A Temporal Perspective on Semantic-ID Generation](https://arxiv.org/abs/2607.21101)
...
### [154] [AttriMem: Attribution-Guided Process Feedback for Agent Memory Learning](https://arxiv.org/abs/2607.21106)
...
### [155] [V-DEAL: Diagnosing Video Safety De-Calibration as an Understanding-Refusal Coupling Failure](https://arxiv.org/abs/2607.21151)
...
### [156] [Safeguards for Speech2Speech LLM-Assistants: A Case Study in Automotive Applications](https://arxiv.org/abs/2607.21180)
...
### [157] [Explaining Weather Bulletins via ILP](https://arxiv.org/abs/2607.21184)
...
### [158] [Differentiable Logic Programming to Mitigate Reasoning Shortcuts in Neurosymbolic Systems](https://arxiv.org/abs/2607.21185)
...
### [159] [Identifying Good Rules for Efficient SAT Encodings of Single-Constant Multiplication Using Machine Learning](https://arxiv.org/abs/2607.21188)
...
### [160] [Bound-Founded Semantics for Answer Set Programming with Difference Constraints: Preliminary Report](https://arxiv.org/abs/2607.21201)
...
### [161] [A New Well-Supported Semantics for Description Logic Programs](https://arxiv.org/abs/2607.21203)
...
### [162] [How Rules Represent Causal Knowledge: Causal Modeling with Probabilistic Logic Programming](https://arxiv.org/abs/2607.21208)
...
### [163] [ICAE-Bench: Evaluating Coding Agents as Interactive Project Builders](https://arxiv.org/abs/2607.21217)
...
### [164] [Logic Programming Semantics for Causal Processes](https://arxiv.org/abs/2607.21233)
*Felix Weitkämper*
...
### [165] [BasketEvent: Understanding Who Did What and When in Basketball Videos](https://arxiv.org/abs/2607.21267)
...
### [166] [Expert Behavior Prior Reinforcement Learning](https://arxiv.org/abs/2607.21302)
...
### [167] [Regulating autonomous and agentic AI](https://arxiv.org/abs/2607.21345)
...
### [168] [SPORD: A Simulation-Propose-then-OR-Dispose Approach for Supply Chain Planning](https://arxiv.org/abs/2607.21354)
...
### [169] [Towards Faithful Graph Explanations with Synergistic Edge Effects via Granular Balls](https://arxiv.org/abs/2607.21381)
...
### [170] [Multimodal Pretraining for Generalizable EEG Representation Learning](https://arxiv.org/abs/2607.21384)
...
### [171] [MSBraM: A Multi-scale Self-supervised Brain Foundation Model for Hierarchical EEG Dynamics Learning](https://arxiv.org/abs/2607.21402)
...
### [173] [Logical Regression for Planning with Axioms](https://arxiv.org/abs/2607.21414)
...
### [174] [PATS: Policy-Aware Training Scaffolding for Agentic Reinforcement Learning](https://arxiv.org/abs/2607.21419)
...
### [175] [Bridging the Gap Between Plausibility and Admissibility: Constraint-Aware Flow Maps for Dynamic Graph Systems](https://arxiv.org/abs/2607.21421)
...
### [176] [Agent-Guided Relational Concept Discovery: Toward Interpretable Surgical Margin Assessment](https://arxiv.org/abs/2607.21437)
...
### [177] [Detecting LLM-Generated Tokens in Human--LLM Coauthored Text](https://arxiv.org/abs/2607.21458)
...
### [178] [AREX: Towards a Recursively Self-Improving Agent for Deep Research](https://arxiv.org/abs/2607.21461)
...
### [180] [Same Dangerous Objective, Opposite Advice: Direct Exposure versus Multi-Agent Mediation](https://arxiv.org/abs/2607.21518)
*Linjun Li*
...
### [181] [MIRROR: Learning from the Other View for Multi-Modal Reasoning](https://arxiv.org/abs/2607.21552)
...
### [183] [Beyond Sycophancy: Structured Resistance and Compliance in LLM Moral Reasoning](https://arxiv.org/abs/2607.21558)
