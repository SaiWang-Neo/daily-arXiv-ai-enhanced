...
### [1] [Exact ReLU realization of binary affine refinement iterates via reflection folding and cone switching](https://arxiv.org/abs/2609.11962)
...
### [2] [Global and Unconditional $R$-Linear Convergence of Rank-Compressed Weighted LMSD Sweeps for Strictly Convex Quadratics](https://arxiv.org/abs/2609.12114)
...
### [3] [ADMM and Linearized ADMM for Weakly Convex Minimization](https://arxiv.org/abs/2609.12167)
...
### [4] [Linear Exponential Quadratic Gaussian Covariance Steering](https://arxiv.org/abs/2609.12463)
...
### [5] [Learning-Augmented Optimization for Strategic Two-Echelon Spare Parts Network Design](https://arxiv.org/abs/2609.12524)
...
### [6] [Discrete Potential Optimization for Absolute Value Equations: A Sign-Flip Framework with Polynomial Complexity](https://arxiv.org/abs/2609.12763)
...
### [7] [High-Probability Convergence of SGD via Batched Updates](https://arxiv.org/abs/2609.12765)
...
### [8] [Joint Random Access and Localization in Cell-Free User-Centric Networks with Frequency-Selective Fading Channels](https://arxiv.org/abs/2609.12140)
...
### [9] [Confusion-Erasure Bounds of Error-Bounded Decoders under QAM](https://arxiv.org/abs/2609.12631)
...
### [10] [Random Access and Localization in Cell-Free User-Centric Networks with Multipath Channels](https://arxiv.org/abs/2609.12141)
*Simon Tarboush,Eleni Gkiouzepi,Giuseppe Caire*
...
### [11] [What Drives Recovery in Agentic Text-to-Cypher? LAST-CQ: An LLM Agent Self-Refinement Framework](https://arxiv.org/abs/2609.12746)
...
### [12] [Occamy-1.0: Open Pareto-frontier 35B Intelligence for Co-work](https://arxiv.org/abs/2609.11977)
...
### [13] [Reading the Whole Heart: Latent-Attention Masked Autoencoders for Multimodal Cardiac Representation Learning](https://arxiv.org/abs/2609.12035)
...
### [14] [Language Is an Insufficient Substrate for Quantitative Reasoning, and Consequential Domains Need Large Quantitative Models](https://arxiv.org/abs/2609.12105)
...
### [15] [DU-NO: A Parameter-Efficient Double U-Shaped Neural Operator for Phase-Resolving Wave Modeling](https://arxiv.org/abs/2609.12115)
...
### [16] [Mined from Scientific Literature: Process Schemas for Atomic Layer Deposition and Etching in Materials Science](https://arxiv.org/abs/2609.12139)
...
### [17] [Can LLMs in Draft-Verify-Revise Pipelines Resolve Deictic Ambiguity?](https://arxiv.org/abs/2609.12162)
*Obinna I. Ekekezie*
...
### [18] [GLARE: Generative Learning via Adversarial Reward Estimation For Social Dynamics Forecasting](https://arxiv.org/abs/2609.12165)
...
### [19] [WinSyn: An Automated Pipeline for Realistic Enterprise Question-Answering Evaluation](https://arxiv.org/abs/2609.12171)
...
### [21] [OneLA: Scaling Linear-Attention Decoding to Large Beams in Generative Recommendation](https://arxiv.org/abs/2609.12399)
...
### [22] [Hybrid Physics-AI Framework of Body Center of Mass Dynamics from Wrist-Worn Sensors](https://arxiv.org/abs/2609.12304)
...
### [23] [GTA: Graph Theory Agent and Benchmark for Algorithmic Graph Reasoning with LLMs](https://arxiv.org/abs/2609.12265)
...
### [24] [Autonomous Research for Open-Ended Problems: A Case Study on Telecom Ticket Retrieval](https://arxiv.org/abs/2609.13073)
...
### [26] [Learning Symbolic Constraint Representations from Examples: A Neuro-Symbolic Approach](https://arxiv.org/abs/2609.12267)
...
### [27] [T-GADE: Thermodynamical Generative-AI-Driven Evolution of LLM Artifacts](https://arxiv.org/abs/2609.12286)
...
### [28] [Robust Prototypical Networks for Few-Shot Sensor Fault Diagnosis](https://arxiv.org/abs/2609.12287)
...
### [32] [Toward Robust Personalized Alignment for LLMs: Mitigating Persona Drift in Multi-Turn Dialogue](https://arxiv.org/abs/2609.12373)
...
### [33] [BlueLM-GUI Technical Report: A Real-Device-Centric Flywheel for Self-Improving Mobile GUI Agents](https://arxiv.org/abs/2609.12394)
...
### [34] [Is Gaussian Splatting Becoming Neural Again? A Taxonomy and Controlled Study of Learned Parameterization](https://arxiv.org/abs/2609.12395)
...
### [36] [Decentralized Evolution of Hexapod Gaits with Independent Leg Controllers](https://arxiv.org/abs/2609.12400)
...
### [37] [Beyond ID Embeddings: Process-Grounded Language Modeling for Cognitive Diagnosis](https://arxiv.org/abs/2609.12403)
...
### [38] [VRL-Bench: Benchmarking agents on computer control tasks under finite trial budgets](https://arxiv.org/abs/2609.12404)
...
### [39] [SoK: Rethinking Jailbreaking in the Era of Agentic AI: Attacks, Defenses, and Practical Consideration](https://arxiv.org/abs/2609.12413)
...
### [40] [Hierarchical Belief Modeling for Zero-Shot Opponent Adaptation in Partially Observable Multi-Agent Navigation](https://arxiv.org/abs/2609.12422)
...
### [41] [LifeFuse-Mem: Lifecycle-Aware State Fusion Against Temporary Overwriting for Long-Term Memory](https://arxiv.org/abs/2609.12436)
...
### [45] [TripPattern: A Pattern-based Text Watermarking Method for Large Language Models](https://arxiv.org/abs/2609.12472)
...
### [46] [When Does AI Augment Work? A Workflow-Level Framework for Human-Agent Collaboration](https://arxiv.org/abs/2609.12482)
...
### [47] [Confidence-Gated Transductive Test Generation for Code Reranking](https://arxiv.org/abs/2609.12489)
...
### [73] [Embodied-BenchForge: A Closed-Loop Agentic Workflow for Embodied Benchmark Construction](https://arxiv.org/abs/2609.13082)
...
### [74] [CMA-OT: Hierarchical Expert Supervision for Dance-to-Music Generation](https://arxiv.org/abs/2609.13118)
...
### [75] [A Hybrid LSTM-XGBoost Framework for Multi-Horizon Stock Return Prediction Across Diversified Equity Portfolios](https://arxiv.org/abs/2609.13125)
...
### [76] [Rethinking Heterogeneous System Disaggregation for Subquadratic Attention](https://arxiv.org/abs/2609.13134)
...
### [77] [Abstract homogeneous chains: a Lyapunov framework for high-order sliding modes in multi-agent systems](https://arxiv.org/abs/2609.12250)
...
### [78] [Very Exciting: Zero-Shot Model Predictive Control of Buildings via Excitation-Based Generalized Transfer Learning Models](https://arxiv.org/abs/2609.12853)
...
### [79] [End-to-End Battery Dispatch with Exact Rainflow Degradation via Mixed-Integer Differentiable Predictive Control](https://arxiv.org/abs/2609.12968)
...
### [80] [An Adaptive Multi-Parameter ADMM Algorithm for Embedded MPC](https://arxiv.org/abs/2609.12992)
...
### [81] [An Equivariant Filter for Spacecraft Nonlinear Relative Navigation with Range and Bearing Measurements](https://arxiv.org/abs/2609.13094)
...
### [82] [Adaptive Agent Design](https://arxiv.org/abs/2609.12486)
...
### [83] [Computing at Sea: Floating and Offshore Data Centres as a Pathway to Sustainable AI Infrastructure](https://arxiv.org/abs/2609.12511)
...
### [84] [Asynchronous Parallel Search for Exact Multi-Objective Shortest Paths with Versioned Frontier Snapshots and Indexed Dominance Pruning](https://arxiv.org/abs/2609.11944)
...
### [85] [Efficient Vision-Language-Action Management and Serving for Robot Factories](https://arxiv.org/abs/2609.12075)
...
### [86] [Consensus-based Decentralized Distributed Swarm Learning with Heterogeneous Big Data](https://arxiv.org/abs/2609.12143)
...
### [87] [Specifying Paxos for System Builders: Pseudocode Made Executable](https://arxiv.org/abs/2609.12239)
...
### [88] [Argus: Orchestrating Cross-Layer GPU Performance Measurements around Semantic Regions](https://arxiv.org/abs/2609.12299)
...
### [89] [HeatCache: Thermal-aware Energy-efficient LLM Inference Scheduling for Chassis-level Liquid Cooling in Sustainable Edge Server Rooms](https://arxiv.org/abs/2609.12449)
...
### [90] [RoofLang: Enabling AI-Driven Architecting of LLM Inference Systems](https://arxiv.org/abs/2609.12551)
...
### [91] [GreenDirector: carbon- and water-aware workload placement for sustainable computing](https://arxiv.org/abs/2609.12602)
...
### [92] [A Dynamic Vertical Scaling Strategy for Distributed Stream Processing Applications in Edge Computing](https://arxiv.org/abs/2609.12975)
...
### [93] [Learning the Topology of a Simplicial Complex Using Noisy Simplicial Signals](https://arxiv.org/abs/2609.12866)
...
### [94] [Where to Defend? Layer-Wise Adversarial Training for Robust Transformer-Based Semantic Communications](https://arxiv.org/abs/2609.13128)
...
### [95] [The Mechanics of a Swarm: A Reproducible External Reconstruction of an Unintended Agent-Coordination Episode on a Third-Party Wiki](https://arxiv.org/abs/2609.12748)
*Philipp Lütje*
...
### [96] [InitGen: Candidate Generation for Interaction Initiation in Intelligent Assistants](https://arxiv.org/abs/2609.11953)
...
### [97] [Recommendation Retrievers Need Verifiers: Universal Generative Reranking for Sequential Recommendations](https://arxiv.org/abs/2609.12270)
...
### [98] [Preference-Drift-Aware Subsequence Learning and Hierarchical Context Fusion for Long-Sequence Generative Recommendation](https://arxiv.org/abs/2609.12556)
...
### [99] [Learning the Lake: Reliable Experience for Adaptive Data Product Discovery](https://arxiv.org/abs/2609.12754)
...
### [100] [A Historical Corpus Is Not a Historical System: Auditing Hindsight Leakage in Stateful Data Discovery](https://arxiv.org/abs/2609.12766)
*Yixi Zhou,Fan Zhang,Sikun Wang,Yingfan Xu,Haipeng Zhang*
...
### [101] [MIMA: Multi-Interest Recommendation via Multi-Positive Exclusive Assignment](https://arxiv.org/abs/2609.12842)
